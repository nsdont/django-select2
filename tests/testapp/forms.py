...
from django_select2.forms import (
    ...
    Select2Widget,
    AutoHeavySelect2MultipleWidget, AutoHeavySelect2Widget)
...
class ArtistForm(forms.Form):
    title = forms.CharField(max_length=50)
    genres = forms.ModelMultipleChoiceField(widget=AutoHeavySelect2MultipleWidget(
...
class AlbumForm(forms.Form):
    ...
    artist = forms.ModelChoiceField(widget=AutoHeavySelect2Widget(
        model=models.Artist,
        search_fields=['title__icontains']
